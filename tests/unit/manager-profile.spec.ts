...
describe('manager profile identity', () => {
  ...
  it('sanitizes the header photo and falls back to initials when it cannot load', async () => {
    ...
    authStore.user.photo_url = 'https://cdn.example.test/header-new.jpg';
    await wrapper.vm.$nextTick();

    expect(wrapper.get('.app-header-bar__avatar .header-image-stub').attributes('src')).toBe(
      'https://cdn.example.test/header-new.jpg',
    );
